...
class Payment extends Model{
    ...
    public function __construct($txn_id,$mc_gross,$payment_status,$item_number,$item_name,$payer_id,$payer_email,
                                $full_name,$address_street,$address_city,$address_state,$address_zip,$address_country,$payment_date)
    {
        $this->txn_id = $txn_id;
