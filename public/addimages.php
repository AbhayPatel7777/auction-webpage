...
if(isset($_POST['submit'])) {
	...
	if(isset($_GET['error'])) {
		...
		<form enctype="multipart/form-data" action="<?php echo $_SERVER['REQUEST_URI']; ?>"
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <!-- Input 1: Hidden field for max file size -->
                ...
                <tr>
                    <td></td>
                    <td>
                        <!-- Input 2: File input for image file -->
        ...
        When you have finished adding photos, go and <a href="<?php echo "itemdetails.php?id=" . $item->get('id'); ?>">see your item</a>!
        <?php
    }
}
